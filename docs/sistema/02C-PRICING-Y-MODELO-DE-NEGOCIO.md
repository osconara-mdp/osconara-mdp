...
> **Nota sobre trial (aplica a B/C/F):** 7 dias puede ser un punto de partida, no una verdad
> universal. La longitud del onboarding y del trial se decide por tiempo a valor, frecuencia y datos
> propios; no se copia el patron de otra app. Avisar fecha y monto antes del cobro. Config en `18`;
> operacion y fuentes en `60`; loops de retencion en `24`.
