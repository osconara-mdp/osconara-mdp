...
(2) HEADLINE: max 8-10 palabras. Sale del PROCESO OBLIGATORIO del `52` (10 variantes →
    ...
    El PRIMER tap en X/"Ahora no" CIERRA o vuelve al estado anterior. No abre una segunda pantalla
    emocional, encuesta ni oferta de rescate. La cancelación retentiva de 58 es para un suscriptor
    que quiere cancelar, no para presionar a quien descarta un paywall.
...
Para nichos B/C/F (bienestar, fitness, finanzas — trial 5-9 días de `02C`), reemplazar
...
### C4ter. Checkout externo sin peaje

En web apps con Hotmart, el CTA abre el checkout directo por defecto. No insertar formulario de
email ni una confirmacion adicional. Texto recomendado: `Ir a Hotmart y activar mi prueba`; ayuda:
...
❌ Primer cierre abre otra presión              → cerrar/volver en el primer tap
