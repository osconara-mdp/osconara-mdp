...
2. Crear PLAN ANUAL (en la landing/paywall se muestra como $/mes, NUNCA el total — ver 02C y 19).
...
[ ] Mensual y anual: cancelación durante trial, cancelación pagada, past_due, recuperación, refund y chargeback certificados en PAYMENT-CERTIFICATION.md
